    ...
    <div className="flex flex-col min-h-screen">
      <header className="px-4 lg:px-6 h-14 flex items-center">
        <Link className="flex items-center justify-center" href="#">
          ...
          <span className="ml-2 text-2xl font-bold text-primary">Sonique</span>
        </Link>
      ...
      <main className="flex-1 ">
          ...
          <div className="container ml-12 px-4 md:px-6">
            <div className="flex ml-12 flex-col items-center space-y-4 text-center">
              ...
              <p className="mx-auto ml-12 max-w-[700px] text-gray-200 md:text-xl">
                Create interactive streams where your audience picks the soundtrack.
              </p>
              <div className="space-x-4 ml-12">
                <Button className="bg-white text-primary hover:bg-gray-100"><Link href="#cta">Get Started</Link></Button>
        ...
        <section id="how-it-works" className="w-full ml-12 py-12 md:py-24 lg:py-32">
          <div className="container px-4 ml-12 md:px-6">
            ...
            <ol className="grid grid-cols-1 ml-12 md:grid-cols-3 gap-8 list-decimal">
              <li className="flex flex-col items-center text-center">
                <span className="text-lg font-semibold mb-2">Start Your Stream</span>
                <p className="text-gray-600">Easily integrate Sonique with your favorite streaming platform.</p>
              </li>
              <li className="flex flex-col items-center text-center">
                <span className="text-lg font-semibold mb-2">Fans Suggest Songs</span>
                <p className="text-gray-600">Your audience browses our vast library and suggests tracks.</p>
              </li>
              <li className="flex flex-col items-center text-center">
                <span className="text-lg font-semibold mb-2">Viewers Vote</span>
                <p className="text-gray-600">Democratic voting ensures the most popular tracks get played.</p>
              </li>
            </ol>
          </div>
        </section>
          ...
          <div className="container px-4 ml-12 md:px-6">
            <div className="flex flex-col ml-12 items-center space-y-4 text-center text-white">
              ...
              <p className="mx-auto  max-w-[600px]  text-gray-200 md:text-xl/relaxed">
                Join Sonique today and give your audience the power to create the perfect soundtrack for your content.
              </p>
              <div className="w-full  max-w-sm space-y-2">
                <form className="flex  space-x-2">
                  <Input className="flex-1 bg-white text-gray-900" placeholder="Enter your email" type="email" />
      ...
      <footer className="flex flex-col gap-2 sm:flex-row py-6 w-full shrink-0 items-center px-4 md:px-6 border-t">
        <p className="text-xs text-gray-500">© 2023 Sonique. All rights reserved.</p>
